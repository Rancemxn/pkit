...
requirements = Cython==0.29.33,Pillow,kivy,android,ffmpeg_bin,pyjnius,requests,pysmartdl2,urllib3,loguru,vgmstream,plyer,UnityPy==1.22.2,astc-encoder-py,attrs,etcpak,fsspec,pyfmodex,texture2ddecoder,liblzma
